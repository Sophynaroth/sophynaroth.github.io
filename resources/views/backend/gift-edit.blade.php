  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-3">
          ...
          <form action="{{route('gift.update')}}" class="container p-3" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-3">
              <input type="hidden" name="id" value="{{ $gift->id }}">
              <label for="exampleFormControlInput1" class="form-label">Gift Name</label>
              <input type="text" class="form-control border border-1 rounded" name="giftName" value="{{ $gift->giftName }}" id="exampleFormControlInput1">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control border border-1 rounded" name="typeGift" value="{{ $gift->typeLevel }}" id="exampleFormControlInput1">
